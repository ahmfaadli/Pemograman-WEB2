...
require_once "../../Praktikum3/proses_regis.php";
?>
...
<form method="POST">
    ...
    <div class="form-group row">
        ...
        <div class="custom-control custom-checkbox custom-control-inline">
            <input name="jenis_kelamin" id="jenis_kelamin_0" type="checkbox" class="custom-control-input" value="Pria" > 
            <label for="jenis_kelamin_0" class="custom-control-label">Pria</label>
        </div>
        <div class="custom-control custom-checkbox custom-control-inline">
            <input name="jenis_kelamin" id="jenis_kelamin_1" type="checkbox" class="custom-control-input" value="Wanita" > 
